...
<Callout type="info">
If you have a B2B application, the provider initiated login flow lets user access your application from their Organization's App Portal. 
...
### Managing Invites
To manage outstanding invitations, redirect the inviter to `https://wallet.hello.coop/invite` with the following parameters:
