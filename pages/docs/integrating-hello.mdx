...
- <span>purple</span> is the **header** that describes the JWT;
- <span>yellow</span> is the **payload** of the ID Token; and
- <span>green</span> is the **signature** of the JWT.
...
TBD USE ANSI FOR EXAMPLE ID TOKEN LIKE BELOW
```ansi
