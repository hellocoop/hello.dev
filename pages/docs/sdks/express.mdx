...
The environment variable `HELLO_COOKIE_SECRET` must be set to 32 char (16 byte) random hex string is required to encrypt cookies used by this package. This can be in `.env` for local development. 
