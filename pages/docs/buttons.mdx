...
```
<div class="hello-container">
  <button className="hello-btn">ō&nbsp;&nbsp;&nbsp;Continue with Hellō</button>
  <button className="hello-about">Rohan - would  you make this act like the tooltip?</button>
</div>
...
<div class="hello-container">
  <button className="hello-btn" lang="es">ō&nbsp;&nbsp;&nbsp;Continue with Hellō</button>
  <button className="hello-about">Rohan - would you make this act like the tooltip?</button>
</div>
