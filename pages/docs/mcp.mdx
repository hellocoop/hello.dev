...
- **🐛 Report Issues**: [GitHub Issues](https://github.com/hellocoop/mcp/issues) - Found a bug or have a feature request?
- **🔧 Contribute**: [Submit Pull Requests](https://github.com/hellocoop/mcp/pulls) - Help us improve the server
- **📖 Documentation**: [Full API documentation](https://console.hello.coop/documentation)
- **💬 Community**: [Join our Discord](https://discord.gg/hellocoop) - Get help and share feedback
