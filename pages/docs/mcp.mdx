...
* Run `hello_manage_app` with `action: "read"` to list your apps
* Double-check that you’re using the correct `client_id`

### Logo upload issues

* Ensure `logo_content_type` matches the file type
...
* [MCP Server Docs](https://github.com/hellocoop/MCP)
* [GitHub Issues](https://github.com/hellocoop/MCP/issues)
* [Pull Requests](https://github.com/hellocoop/MCP/pulls)
* [Join our Slack Community](https://hello-community.slack.com/join/shared_invite/zt-1eccnd2np-qJoOWBkHGnpxvBpCTtaH9g#/shared-invite/email)
