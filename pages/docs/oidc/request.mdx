...
|`login_hint`<br/>*optional*|A hint for which user account to use. Example `login_hint=name@domain.example`.|
|`domain_hint`<br/>*optional*|A hint for which domain the user's managed account belongs to. Example `domain_hint=domain.example`.|
