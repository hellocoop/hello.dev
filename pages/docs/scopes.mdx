...
The following scopes can only be used individually, IE only with the `openid` scope. They allow a user to provide a different claim.

|Update Scopes|Description|
|----|----|
|`update_email`| Update email |
|`update_phone`| Update phone |
|`update_picture`| Update picture |
|`update_profile`| will update `email`,`name`, and `picture`|
