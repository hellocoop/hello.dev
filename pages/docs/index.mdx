...
Login providers include: Apple, Discord, Facebook, Google, GitHub, GitLab, Tumblr, Twitch, X (Twitter), Line, Mastodon, MetaMask, Microsoft, WordPress.com, Yahoo. We also support OTP over email, and QR codes for logging into a desktop with your phone. Mobile devices will prompt the user to register a Passkey for a streamlined experience on their return. 
