...
Check out the [Using Hellō](/docs/getting-started) documentation. 
...
<button className="hello-btn hello-btn-white-and-static" style={{marginTop: "10px"}}>ō&nbsp;&nbsp;&nbsp;Update with Hellō</button> 
