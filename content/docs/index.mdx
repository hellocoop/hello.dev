...
<Cards>
  <Cards.Card icon={<QuickstartIcon/>} title="Quickstarts" href="/docs/quickstarts" />
  <Cards.Card icon={<ButtonIcon/>} title="Hellō Buttons" href="/docs/buttons" />
  <Cards.Card icon={<ScopesIcon/>} title="Hellō Scopes" href="/docs/scopes" />
  <Cards.Card icon={<SDKIcon/>} title="SDK Reference" href="/docs/sdks" />
  <Cards.Card icon={<APIIcon/>} title="API Reference" href="/docs/apis" />
  <Cards.Card icon={<OIDCIcon/>} title="OpenID Connect" href="/docs/oidc" />
  <Cards.Card icon={<CompareIcon/>} title="Comparison" href="/docs/comparison" />
  <Cards.Card icon={<RoadmapIcon/>} title="Roadmap" href="/docs/roadmap" />
</Cards>
...
Hellō currently supports Arabic `ar`, English `en`, French `fr`, German `de`, Hindi `hi`, Portuguese `pr`, & Spanish `es`. We welcome [translations](https://github.com/hellocoop/wallet-i18n)!
