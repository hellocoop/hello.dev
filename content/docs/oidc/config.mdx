...
| Parameter                | URL                                                                                                                  |
|--------------------------|----------------------------------------------------------------------------------------------------------------------|
| `openid-configuration`   | <Pre data-copy="" style={{marginBottom: 0}}>`https://issuer.hello.coop/.well-known/openid-configuration`</Pre> |
| `issuer`                 | <Pre data-copy="" style={{marginBottom: 0}}>`https://issuer.hello.coop`</Pre>                                  |
| `authorization_endpoint` | <Pre data-copy="" style={{marginBottom: 0}}>`https://wallet.hello.coop/authorize`</Pre>                        |
| `token_endpoint`         | <Pre data-copy="" style={{marginBottom: 0}}>`https://wallet.hello.coop/oauth/token`</Pre>                      |
| `userinfo_endpoint`      | <Pre data-copy="" style={{marginBottom: 0}}>`https://wallet.hello.coop/oauth/userinfo`</Pre>                   |
