...
<a href="cursor://anysphere.cursor-deeplink/mcp/install?name=hello-admin&config=eyJ1cmwiOiJodHRwczovL2FkbWluLW1jcC5oZWxsby5jb29wIn0K" className="inline-block">
...
<span className="-mb-4 block" />
```bash
claude mcp add --transport http hello-admin https://admin-mcp.hello.coop/
```
<span className="-mt-4 block" />
...
See [Qodo Gen](https://docs.qodo.ai/qodo-gen/tools-mcps/agentic-tools-mcps) for more information.
