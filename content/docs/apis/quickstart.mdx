...
3. Import the `@hellocoop/quickstart` npm package as documented [here](https://www.npmjs.com/package/@hellocoop/quickstart).
...
The Quickstart API supports the following environment variables:
