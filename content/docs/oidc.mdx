...
<Cards>
  <Cards.Card icon={<AuthRequestIcon/>} title="Auth Request" href="/docs/oidc/request/" />
  <Cards.Card icon={<AuthResponseIcon/>} title="Auth Response" href="/docs/oidc/response/" />
  <Cards.Card icon={<VerificationIcon/>} title="Verification" href="/docs/oidc/verification/" />
  <Cards.Card icon={<IDTokenIcon/>} title="ID Token" href="/docs/oidc/token/" />
  <Cards.Card icon={<ConfigIcon/>} title="Configuration" href="/docs/oidc/config/" />
  <Cards.Card icon={<ErrorIcon/>} title="Error Responses" href="/docs/oidc/errors/" />
</Cards>