...
<button class="hello-btn hello-btn-black-and-static" style={{marginLeft: "28px", marginTop: "10px"}}>ō&nbsp;&nbsp;&nbsp;Continue with Hellō</button>
...
<button class="hello-btn hello-btn-white-and-static" style={{marginTop: "10px"}}>ō&nbsp;&nbsp;&nbsp;Update Email with Hellō</button>
